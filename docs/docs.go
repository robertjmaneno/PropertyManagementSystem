    ...
    "paths": {
        "/buildings": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Sort fields (format: field1:asc,field2:desc) - Available fields: first_name, last_name, email, created_at",
                        "name": "sort",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "List of buildings with pagination information",
                        "schema": {
                            "$ref": "#/definitions/dto.ListBuildingsResponse"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/dto.BuildingResponse"
                        }
                    },
                    "400": {
        ...
        "/buildings/search": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search query (e.g., building name )",
                        "name": "search",
                        "in": "query",
                        "required": true
                    },
                ...
                "responses": {
                    "200": {
                        "description": "List of buildings matching search criteria with pagination info",
                        "schema": {
                            "$ref": "#/definitions/dto.ListBuildingsResponse"
                        }
                    },
        ...
        "/buildings/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Building information to be updated",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateBuildingRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/communities": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of communities with pagination information",
                        "schema": {
                            "$ref": "#/definitions/dto.ListCommunitiesResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid input parameters",
        ...
        "/communities/search": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search query (e.g., community name )",
                        "name": "search",
                        "in": "query",
                        "required": true
                    },
                ...
                "responses": {
                    "200": {
                        "description": "List of communities matching search criteria with pagination info",
                        "schema": {
                            "$ref": "#/definitions/dto.ListCommunitiesResponse"
                        }
                    },
        ...
        "/communities/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Community information to be updated",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateCommunityRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/units": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Sort fields (format: field1:asc,field2:desc) - Available fields: unit_number, name, created_at",
                        "name": "sort",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "List of units with pagination information",
                        "schema": {
                            "$ref": "#/definitions/dto.ListUnitsResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid input parameters",
        ...
        "/units/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Unit information to be updated",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
